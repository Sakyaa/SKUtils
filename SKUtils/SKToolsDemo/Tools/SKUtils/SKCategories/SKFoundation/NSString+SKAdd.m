...
- (NSString *)sk_hmacMD5StringWithKey:(NSString *)key {
    return [[self dataUsingEncoding:NSUTF8StringEncoding]
            sk_hmacMD5StringWithKey:key];
}
- (NSString *)sk_md5String {
    
    return [[self dataUsingEncoding:NSUTF8StringEncoding] sk_md5String];
...
- (NSString *)sk_base64EncodedString {
    return [[self dataUsingEncoding:NSUTF8StringEncoding] sk_base64EncodedString];
}
...
+ (NSString *)sk_stringWithBase64EncodedString:(NSString *)base64EncodedString {
    NSData *data = [NSData sk_dataWithBase64EncodedString:base64EncodedString];
...
- (NSString *)sk_aes256_encrypt:(NSString *)key {
    ...
    //对数据进行加密
    NSData *result = [data sk_aes256_encrypt:key];
...
- (NSString *)sk_aes256_decrypt:(NSString *)key {
    ...
    //对数据进行解密
    NSData* result = [data sk_aes256_decrypt:key];
    if (result && result.length > 0) {
