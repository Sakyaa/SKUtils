...
@implementation UIApplication (SKAdd)
- (NSURL *)documentsURL {
...
- (BOOL)isPirated {
    ...
    if (![self _sk_fileExistInMainBundle:@"_CodeSignature"]) {
        return YES;
    }
    
    if (![self _sk_fileExistInMainBundle:@"SC_Info"]) {
        return YES;
    }
...
- (BOOL)_sk_fileExistInMainBundle:(NSString *)name {
